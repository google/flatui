...
#ifndef FLATUI_INTERNAL_ANTIALIAS_DISTANCE_COMPUTER_H
#define FLATUI_INTERNAL_ANTIALIAS_DISTANCE_COMPUTER_H
...
//
// The AntialiasDistanceComputer class implements the main functions to
...
class AntialiasDistanceComputer : public DistanceComputer<T, FundamentalType> {
 public:
  AntialiasDistanceComputer() : any_distance_changed_(false) {}
  ~AntialiasDistanceComputer() {}
  ...
  void Compute(const Grid<T, FundamentalType>& image,
               Grid<T, FundamentalType>* dest, GlyphFlags flag) override {
...
#endif  // FLATUI_INTERNAL_ANTIALIAS_DISTANCE_COMPUTER_H
